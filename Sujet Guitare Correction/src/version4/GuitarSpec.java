...
public class GuitarSpec {
	...
	public boolean matches(GuitarSpec searchGuitar) {
		...
		if (searchGuitar.getBuilder() != null 
				&& !searchGuitar.getBuilder().equals(getBuilder()))
			return false;
		...
		if (searchGuitar.getType() != null 
				&& !searchGuitar.getType().equals(getType()))
			return false;
		if (searchGuitar.getTopWood() != null 
				&& !searchGuitar.getTopWood().equals(getTopWood()))
			return false;
		if (searchGuitar.getBackWood() != null 
				&& !searchGuitar.getBackWood().equals(getBackWood()))
			return false;
		if (searchGuitar.getNumStrings() != NO_PREF_NUM_STRINGS 
				&& searchGuitar.getNumStrings() != getNumStrings())
			return false;
